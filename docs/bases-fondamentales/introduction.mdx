...
**Objectif** : acquérir les fondamentaux de l'informatique sont nécessaires pour comprendre et exceller dans n'importe quelle domaine.
...
Cette vision est découpé en **2 phases**, la première phase concerne les **éléments constitutifs d'un programme**, la seconde quant à elle
...
-   **PSR** — _PHP Standard Recommendations_
    ...
    **Exemple de normes PSR**
    ...
    et savoir les mettres en place.
    :::
